...
def extractInvoice(request):
    try:
        ...
        if request.method == 'POST':
            ...
            dictinvoice['billingdateto'] = request.POST('billingdateto')
            dictinvoice['remarks'] = request.POST('remarks')
            dictinvoice['fullsiteaddress'] = request.POST('fullsiteaddress')
            dictinvoice['customerid'] = request.POST('customerid')
            dictinvoice['servicetype'] = request.POST('servicetype')
            dictinvoice['billingdatefrom'] = request.POST('billingdatefrom')
            dictinvoice['speed'] = request.POST('speed')
            dictinvoice['division'] = request.POST('division')
            dictinvoice['taxname'] = request.POST('taxname')
            dictinvoice['total'] = request.POST('total')
            dictinvoice['accountno'] = request.POST('accountno')
            dictinvoice['pin'] = request.POST('pin')
            dictinvoice['circuitid'] = request.POST('circuitid')
            dictinvoice['invoicedate'] = request.POST('invoicedate')
            dictinvoice['invoiceno'] = request.POST('invoiceno')
            dictinvoice['siteid'] = request.POST('siteid')
            dictinvoice['gstno'] = request.POST('gstno')
            dictinvoice['premiseno'] = request.POST('premiseno')
            dictinvoice['city'] = request.POST('city')
            dictinvoice['tsp'] = request.POST('tsp')
            dictinvoice['slno'] = request.POST('slno')
            dictinvoice['premisename'] = request.POST('premisename')
