...
function b(p){for(var w=g,r=0;64>r;r+=4)w[r/4]=p[r]<<24|p[r+1]<<16|p[r+2]<<8|p[r+3];for(r=16;80>r;r++)p=w[r-3]^w[r-8]^w[r-14]^w[r-16],w[r]=(p<<1|p>>>31)&4294967295;p=e[0];var E=e[1],U=e[2],na=e[3],Ac=e[4];for(r=0;80>r;r++){if(40>r)if(20>r){var Ha=na^E&(U^na);var Gb=1518500249}else Ha=E^U^na,Gb=1859775393;else 60>r?(Ha=E&U|na&(E|U),Gb=2400959708):(Ha=E^U^na,Gb=3395469782);Ha=((p<<5|p>>>27)&4294967295)+Ha+Ac+Gb+w[r]&4294967295;Ac=na;na=U;U=(E<<30|E>>>2)&4294967295;E=p;p=Ha}e[0]=e[0]+p&4294967295;e[1]=
e[1]+E&4294967295;e[2]=e[2]+U&4294967295;e[3]=e[3]+na&4294967295;e[4]=e[4]+Ac&4294967295}
...
;function zc(a){var b=vc(String(x.location.href)),c=x.__OVERRIDE_SID;null==c&&(c=(new Sb(document)).get("SID"));if(c&&(b=(c=0==b.indexOf("https:")||0==b.indexOf("chrome-extension:"))?x.__SAPISID:x.__APISID,null==b&&(b=(new Sb(document)).get(c?"SAPISID":"APISID")),b)){c=c?"SAPISIDHASH":"APISIDHASH";var d=String(x.location.href);return d&&b&&c?[c,xc(vc(d),b,a||null)].join(" "):null}return null}
